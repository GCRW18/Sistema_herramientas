...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _erpPlatformService: ErpPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._erpMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._erpPlatformService.osName
        );
    }
