...
export class RetornoCalibracionComponent {
    public dialogRef = inject(MatDialogRef<RetornoCalibracionComponent>, { optional: true });

    searchText: string = '';

    displayedColumns: string[] = [
        'filaObs', 'cantidad', 'descripcion', 'modeloPn', 'serialNumber',
        'codigoBoa', 'fechaEntrega', 'empresa', 'nroNota'
    ];

    dataSource: CalibrationReturn[] = [];
    ...
    consultar(): void {
        ...
        // Simulación de datos
        this.dataSource = [
            { filaObs: 1, cantidad: 2, descripcion: 'Manómetro Digital', modeloPn: 'MD-200', serialNumber: 'SN-99', codigoBoa: 'BOA-77', fechaEntrega: '2024-04-01', empresa: 'CalibTec', nroNota: 'N-500' }
        ];
    }
