...
export class AdministrationComponent implements OnInit {
    ...
    recentRecords: AdminRecord[] = [
        ...
        { fecha: '03/01/2026', tipo: 'EDITAR PROVEEDOR', entidad: 'Ferretería BOA', usuario: 'SUPERVISOR' },
        { fecha: '02/01/2026', tipo: 'ASIGNAR ROL', entidad: 'Técnico Senior', usuario: 'ADMIN' }
    ];
