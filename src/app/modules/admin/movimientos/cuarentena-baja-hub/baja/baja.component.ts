...
export class BajaComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.initForm();
        this._setupProcesadoPorSearch();
        this._setupVerificadoPorSearch();
        this._setupAutorizadoPorSearch();
    }
    ...
    private _setupProcesadoPorSearch(): void {
    ...
    private _setupVerificadoPorSearch(): void {
        this._setupFuncionarioSearch(
    ...
    private _setupAutorizadoPorSearch(): void {
        this._setupFuncionarioSearch(
