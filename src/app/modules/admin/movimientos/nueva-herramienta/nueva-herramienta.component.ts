...
import { Subject, takeUntil, finalize, debounceTime, distinctUntilChanged, of } from 'rxjs';
...
export class NuevaHerramientaComponent implements OnInit, OnDestroy {
    ...
    hideFuncDropdown(): void {
        setTimeout(() => this.showFuncDropdown = false, 150);
    }
    ...
    finalizarIngreso(): void {
        ...
        this.movementService.registrarNuevaCompra({
            ...
            responsible_person: recepcion.funcionarioRecibe || '', received_by_name: recepcion.recibiConforme || '',
