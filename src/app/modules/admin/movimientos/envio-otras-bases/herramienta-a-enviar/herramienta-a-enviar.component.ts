...
export class HerramientaAEnviarComponent implements OnInit, OnDestroy {
    ...
    hideToolsSuggestions(): void {
        setTimeout(() => this.showToolsSuggestions = false, 150);
    }
    ...
    selectHerramienta(herramienta: HerramientaOption): void {
        ...
        this._herramientaSeleccionada = { codigo: herramienta.codigo, nombre: herramienta.nombre };
        this.filteredHerramientas = [];
        this.showToolsSuggestions = false;
    ...
    loadEditData(item: any): void {
        ...
        this._herramientaSeleccionada = { codigo: item.codigo, nombre: item.descripcion || item.nombre };
        this.enviarForm.patchValue({
            codigo: item.codigo,
